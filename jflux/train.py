...
Usage:
    # Train with 1000 samples (default, good for testing)
    uv run jflux-train --num_samples 1000 --batch_size 4
    
    # Train with more samples
    uv run jflux-train --num_samples 10000 --batch_size 8 --num_epochs 5
    
    # Disable NSFW filtering
    uv run jflux-train --num_samples 1000 --filter_nsfw False
"""
...
def train(
    ...
    print("=" * 60)
    print("Flux Training Script - DiffusionDB")
    print("=" * 60)
